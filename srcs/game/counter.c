...
{
    add_graphics(&eval_count2, 3, pv2(0, 0), v2(g_ame->pixel_per_tile, g_ame->pixel_per_tile));
    add_graphics(&eval_count1, 4, pv2(g_ame->pixel_per_tile + 1, 0), v2(g_ame->pixel_per_tile, g_ame->pixel_per_tile));
}
